/**
 * @file melody.h
 * @brief PROGMEM melody data for SH2SC-EDT — Transmitter Node A.
...
/**
 * @brief Total number of note/rest entries in the PROGMEM melody table.
 * @details Flash usage: MELODY_LENGTH * 4 bytes = ~2120 bytes of Flash.
 */
static const uint16_t MELODY_LENGTH = 530;

/**
 * @brief PROGMEM melody table — note indices and durations for the Imperial March.
 * @details Stored in Flash (PROGMEM) to avoid consuming 2120 bytes of SRAM.
 *          Access via @c pgm_read_word(&melody[i][col]) — do NOT dereference directly.
 *          - @c melody[i][0]: note index (0–20 or REST_INDEX=255).
 *          - @c melody[i][1]: duration in milliseconds.
 */
